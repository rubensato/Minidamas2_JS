...
`Consigna completa enviada por mail:`
 ...
 - [X] ***7. Detectar el momento en que  un jugador ha ganado la partida y mostrar un cartel informativo.***
 ...
 - [x] _12. Agregar un botón para mostrar un popup con la lista de partidas con jugadores, puntajes y fechas._
